...
const Hero: React.FC = () => {
  return (
    <section id='hero' className="bg-gradient-to-r from-black to-green-900 text-white min-h-screen flex items-end pb-24"
>
      <div className="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-end justify-between">
        ...
        <div className="mt-8 md:mt-0 ">
          ...
          <button className="bg-lime-500 text-black font-medium px-6 py-3  hover:bg-lime-600 transition w-full">
            Our services
          </button>
        </div>
      </div>
