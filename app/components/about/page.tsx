    ...
    <section id='about-us' className="bg-white text-black h-screen flex items-center  ">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col  items-start justify-evenly  h-full   ">
        ...
        <div className="w-full mb-8 md:mb-0  ">
          <h3 className="text-md font-medium tracking-widest text-gray-500 uppercase mb-2 md:mb-8 ">About Us</h3>
        ...
        <div className='w-full flex  justify-end '>
          <div className="w-full md:w-1/2 text-gray-700 space-y-6 text-justify leading-6">
            ...
            <p>
              Join us on this journey as we continue to elevate brands and redefine what's possible
              in the ever-evolving world of digital marketing. Together, let's reach new heights and
